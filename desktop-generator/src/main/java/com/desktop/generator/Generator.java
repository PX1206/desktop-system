package com.desktop.generator;

import com.desktop.generator.properties.GeneratorProperties;
import com.baomidou.mybatisplus.annotation.DbType;
import com.baomidou.mybatisplus.annotation.IdType;
import com.baomidou.mybatisplus.generator.config.rules.DateType;
import com.baomidou.mybatisplus.generator.config.rules.NamingStrategy;
import com.desktop.generator.config.GeneratorStrategy;
import com.desktop.generator.constant.GeneratorConstant;
...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        // 设置基本信息
        generatorProperties
                .setMavenModuleName("desktop-service") // 注意这里的项目目录层级
                .setParentPackage("com.desktop")
        ...
        generatorProperties.getDataSourceConfig()
                ...
                .setUrl("jdbc:mysql://192.168.31.119:3306/desktop_db?useUnicode=true&characterEncoding=UTF-8&useSSL=false");
